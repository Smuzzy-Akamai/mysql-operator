...
```sh
$> kubectl apply -f https://raw.githubusercontent.com/mysql/mysql-operator/8.4.4-2.1.6/deploy/deploy-crds.yaml
```

Then deploy MySQL Operator for Kubernetes:

```sh
$> kubectl apply -f https://raw.githubusercontent.com/mysql/mysql-operator/8.4.4-2.1.6/deploy/deploy-operator.yaml
```
